...
public class EmailSenderTLS implements EmailSender{
	private static Logger log = Logger.getLogger(EmailSenderTLS.class);
	
	private PropertiesService propertiesService;

	public EmailSenderTLS(PropertiesService propertiesService) {
	...
	public void send(String message) {
		...
		props.put("mail.smtp.starttls.enable", propertiesService.get("mail.smtp.starttls.enable"));
