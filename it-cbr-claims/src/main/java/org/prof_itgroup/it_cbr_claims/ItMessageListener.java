package org.prof_itgroup.it_cbr_claims;
		...
		try {
			...
			for (int i = 0; i < documentList.getLength(); i++) {
				...
				for (Map<String, Object> map : listMap) {
					...
					Object[] param = new Object[] { date, currencyid, doubleValue, nominal };
					log.info("dt:"+date+" currencyid:"+currencyid+" rateValue:"+doubleValue+" nominal:"+nominal);
					jdbcHelper.update("insert into CurrencyRates (dt, currencyid, rateValue, nominal) values(?, ?, ?, ?)", param);
				}
