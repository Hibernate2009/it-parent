package org.prof_itgroup.it_directory_customs;
...
public class SgdMessageListener implements MessageListener{
	...
	public SgdMessageListener(PropertiesService propertiesService, SGD sgd) {
	...
	public void onMessage(Message message) {
		try {
			...
			if(!"customs".equalsIgnoreCase(system)){
				log.info("Модуль it-directory-customs принял JSON объект "+directory.getEnum() + " от системы "+directory.getSystem());
